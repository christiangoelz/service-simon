...
"""
Provides recursive assertions for data types such as tuples, lists, and dictionaries
"""
...
class TestAssertions(_unittest.TestCase):
    ...
    def inner_assertion(self, first, second, msg):
        """check if floating point numbers are almost equal, or if integers are equal"""
