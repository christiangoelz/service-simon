...
class TestSimon(TestAssertions):
    ...
    def test_secure_median(self):
        ...
        self.run_two_party_test(microprotocol='SecureMedian',
                                data_alice=[1, 2, 3, 4, 5, 6, 7, 8, 9],
                                data_bob=[10, 11, 12, 13, 14, 15, 16, 17, 18],
                                correct={'median': 9.5})

        self.run_two_party_test(microprotocol='SecureMedian',
                                data_alice=[-970,138,636,626,-75,449,-300,100,352,-168,-918,-23,434],
                                data_bob=[748,672,-221,911,309,108,-235,185,-308,-477,236,537,-778,
                                          168,864,372,449,-267,101,48,-83,-861,-390,-258,786,11,-486,375,294,678,-282,-591,-530],
                                correct={'median': 100.5})

        self.run_two_party_test(microprotocol='SecureMedian',
                                data_alice=[-97,-887,621,-349,280,982,-996,445,259,-744,17,232,184,-171,159,698,981,840,-257,407,-14,-360,858,-804,-833,440,952,231,911,-802,730,373,-149,-836,809,663,881],
                                data_bob=[-626,510,-913,-878,982,535,-671,-231,-246],
                                correct={'median': 207.5})

        self.run_two_party_test(microprotocol='SecureMedian',
                                data_alice=[0.831716252,0.126745429,0.710476552,0.719059441,0.244178834,0.024707453,0.799845091,0.595732707,0.603235169],
                                data_bob=[0.289322013,0.123191087,0.309589152,0.401435888,0.149810757,0.710600217,0.565250515,0.605866414,0.86703249,
                                          0.399420031,0.707189188,0.128262609,0.275647641,0.902004041,0.840246023,0.44665615,0.686489818,0.505423716,
                                          0.327261739,0.641869952,0.905716932,0.71225097,0.759316815,0.842361933,0.541164596,0.597520199,0.831365555,
                                          0.401612055,0.803858239,0.377603516,0.254109827,0.090941054,0.874912006,0.066641412,0.510510482,0.671451831,0.206979523],
